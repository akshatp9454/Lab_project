...
$sql = "insert into teacher(Password,Email,Name,Subject_ID,Phone) values('".$password."','".$email."','".$name."','".$sid."','".$phone."')";
...
<div class="main">
  <div class="innerBox">
   ...
   <li><a href="admin_teacher_update.php"><button  style="background-color:white;color:orange;"><b>Add Teachers</b></button></a><li>
   ...
   <br><br>
     <h1 style="font-size: 3em; font-weight: ]">Add Teacher</h1>
