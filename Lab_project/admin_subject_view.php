...
if(!$_SESSION['admin']){
  header('location:login.php');
   ...
   $sql = 'SELECT Subject_ID,Subject_name,Credits FROM subject';
...
<div class="main">
  <div class="innerBox">
   ...
   <li><a href="admin_subject_view.php"><button   style="background-color:white;color:orange;"><b>View Subjects</b></button></a><li>
   ...
   <br><br>
     <h1 style="font-size: 3em; font-weight: ]">Subject List</h1>
   </div>
...
echo "<tr><td>" . $row['Subject_ID']. "</td> <td>" . $row['Subject_name']. " </td> <td>" . $row['Credits']. "</td><td><a href='delete_subject_view.php?id=".$row['Subject_ID']."'>Delete</td> <td><a href='update_subject_view.php?id=".$row['Subject_ID']."&sname=".$row['Subject_name']."&credits=".$row['Credits']."'>Update</td></tr>";
}
?>
<table>  
