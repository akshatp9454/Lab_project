...
if(!$_SESSION['admin']){
  header('location:login.php');
   ...
   $sql = 'SELECT User_ID,Email,Name,Phone FROM student';
...
<div class="main">
  <div class="innerBox">
   ...
   <li><a href="admin_student_view.php"><button  style="background-color:white;color:orange;"><b>View Students</b></button></a><li>
   ...
   <br><br>
     <h1 style="font-size: 3em; font-weight: ]">Student List</h1>
   </div>
...
echo "<tr><td>" . $row['User_ID']. "</td> <td>" . $row['Email']. " </td> <td>" . $row['Name']. " </td> <td>" . $row['Phone']. "</td><td><a href='delete_student_view.php?id=".$row['User_ID']."'>Delete</td> <td><a href='update_student_view.php?id=".$row['User_ID']."&email=".$row['Email']."&name=".$row['Name']."&phone=".$row['Phone']."'>Update</td></tr>";
}
?>
<table>  
