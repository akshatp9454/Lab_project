...
$sql = "insert into subject(Subject_name,Credits) values('".$name."',".$credits.")";
...
<div class="main">
  <div class="innerBox">
   ...
   <li><a href="admin_subject_update.php"><button  style="background-color:white;color:orange;"><b>Add Subjects</b></button></a><li>
   ...
   <br><br>
     <h1 style="font-size: 3em; font-weight: ]">Add Subject</h1>
