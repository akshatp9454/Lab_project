...
<div class="main">
  <div class="innerBox">
   ...
   <li><a href="admin_exam_view.php"><button style="background-color:white;color:orange;"><b>View Exams</b></button></a><li>
   </ul>
   <br><br>
...
echo "<tr><td>" . $row['Exam_ID']. "</td> <td>" . $row['Subject_ID']. " </td> <td>" . $row['Date']. " </td> <td>" . $row['Start_Time']. " </td> <td>" . $row['End_Time']. " </td> <td>" . $row['Duration']. " </td> <td>" . $row['Total_Marks']. " </td> <td><a href=".$row['Exam_Link'].">" . $row['Exam_Link']."</a></td><td><a href='delete_exam_view.php?id=".$row['Exam_ID']."'>Delete</td> <td><a href='update_exam_view.php?id=".$row['Exam_ID']."&sid=".$row['Subject_ID']."&date=".$row['Date']."&stime=".$row['Start_Time']."&etime=".$row['End_Time']."&dur=".$row['Duration']."&tmarks=".$row['Total_Marks']."&elink=".$row['Exam_Link']."'>Update</td></tr>";
}
?>
<table>  
